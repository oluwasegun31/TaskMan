    ...
    return(
        ...
        <div className='flex justify-center items-center mb-1'>
            ...
            <select 
                ...
                value={data.label}
                onChange={(e)=> setIsData({...data, label: e.target.value})}
            >
        ...
        <div className='flex justify-center items-center mb-1'>
            ...
            <select 
                ...
                value={data.priority}
                onChange={(e)=> setIsData({...data, priority: e.target.value})}
            >
        ...
        <div className='flex justify-center items-center mb-7'>
            ...
            <select 
                ...
                value={data.assignee}
                onChange={(e)=> setIsData({...data, assignee: e.target.value})}
            >
        ...
        <div className='w-full flex flex-col justify-start items-start'>
            ...
            <textarea name="description"
                ...
                value={data.desc}
                onChange={(e)=> setIsData({...data, desc: e.target.value})}
            >
            </textarea>
        </div>
        {/* Submit button */}
